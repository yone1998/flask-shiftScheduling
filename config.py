...
HOPE_SHIFT_ADMIN_HOME_STR = f'希望シフト（{TARGET_YEAR_MONTH[0]}年{TARGET_YEAR_MONTH[1]}月）の提出状況）'
...
DAY_STR_LIST = [f'({SMTWTFS[getNumWeekday(TARGET_YEAR_MONTH, iDay+1)]})' for iDay in range(SUM_DAYS_OF_TARGET_MONTH)] # 曜日のリスト
