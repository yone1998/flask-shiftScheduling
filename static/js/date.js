...
const firstDayOfTargetMonth = new Date(today.getFullYear(), today.getMonth()+1, 1);
const SMTWTFS = ["日", "月", "火", "水", "木", "金", "土"]
const FIRST_SUNDAY_TARGET_MONTH = (SMTWTFS.length - firstDayOfTargetMonth.getDay()) % SMTWTFS.length + 1
